...
public class Result_SD extends JFrame {
	
	/**
	 * Launch the application.
	 */
	public static void main(String[] args) {
		Result_SD frame = new Result_SD();
	...
	public Result_SD() {
		...
		btnbckmenu.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				btnbckmenu.setIcon(new ImageIcon(Result_SD.class.getResource("/images/bcktomenuhover.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btnbckmenu.setIcon(new ImageIcon(Result_SD.class.getResource("/images/bcktomenu.png")));
			}
			@Override
		...
		btnexit.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnexit.setIcon(new ImageIcon(Result_SD.class.getResource("/images/exthover.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btnexit.setIcon(new ImageIcon(Result_SD.class.getResource("/images/ext.png")));
			}
			@Override
			public void mouseClicked(MouseEvent e) {
				System.exit(0);
		...
		bglabel.setIcon(new ImageIcon(Result_SD.class.getResource("/images/bg.png")));
		bglabel.setBounds(0, 0, 450, 730);
		contentPane.add(bglabel);
	}
	
	 class Result_ch1SD extends JFrame {
		...
		public Result_ch1SD() {
			...
			double score = SDquiz.ch1_SD.scores;
	 ...
	 class Result_ch2SD extends JFrame {
			...
			public Result_ch2SD() {
				...
				//call the score for java
				double score = SDquiz.ch2_SD.scores;
				int whole_score = (int) score ;
	 ...
	 class Result_ch3SD extends JFrame {
			...
			public Result_ch3SD() {
				...
				//call the score for java
				double score = SDquiz.ch3_SD.scores;
				int whole_score = (int) score ;
	 ...
	 class Result_ch4SD extends JFrame {
			...
			public Result_ch4SD() {
				...
				//call the score for java
				double score = SDquiz.ch4_SD.scores;
				int whole_score = (int) score ;
	 ...
	 class Result_ch5SD extends JFrame {
			...
			public Result_ch5SD() {
				...
				//call the score for java
				double score = SDquiz.ch5_SD.scores;
				int whole_score = (int) score ;
	 ...
	 class Result_ch6SD extends JFrame {
			...
			public Result_ch6SD() {
				...
				//call the score for java
				double score = SDquiz.ch6_SD.scores;
				int whole_score = (int) score ;

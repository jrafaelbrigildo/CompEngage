...
public class Result_MICRO extends JFrame {

	/**
	 * Launch the application.
	 */
	public static void main(String[] args) {
		Result_MICRO frame = new Result_MICRO();
	...
	public Result_MICRO() {
		...
		btnbckmenu.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				btnbckmenu.setIcon(new ImageIcon(Result_MICRO.class.getResource("/images/bcktomenuhover.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btnbckmenu.setIcon(new ImageIcon(Result_MICRO.class.getResource("/images/bcktomenu.png")));
			}
			@Override
		...
		btnexit.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnexit.setIcon(new ImageIcon(Result_MICRO.class.getResource("/images/exthover.png")));
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btnexit.setIcon(new ImageIcon(Result_MICRO.class.getResource("/images/ext.png")));
			}
			@Override
			public void mouseClicked(MouseEvent e) {
				System.exit(0);
		...
		bglabel.setIcon(new ImageIcon(Result_MICRO.class.getResource("/images/bg.png")));
		bglabel.setBounds(0, 0, 450, 730);
		contentPane.add(bglabel);
	}
	
	 class Result_ch1MICRO extends JFrame {
		...
		public Result_ch1MICRO() {
			...
			double score = MICROquiz.ch1_MICRO.scores;
	 ...
	 class Result_ch2MICRO extends JFrame {
			...
			public Result_ch2MICRO() {
				...
				//call the score for java
				double score = MICROquiz.ch2_MICRO.scores;
				int whole_score = (int) score ;
	 ...
	 class Result_ch3MICRO extends JFrame {
			...
			public Result_ch3MICRO() {
				...
				//call the score for java
				double score = MICROquiz.ch3_MICRO.scores;
				int whole_score = (int) score ;
	 ...
	 class Result_ch4MICRO extends JFrame {
			...
			public Result_ch4MICRO() {
				...
				//call the score for java
				double score = MICROquiz.ch4_MICRO.scores;
				int whole_score = (int) score ;
	 ...
	 class Result_ch5MICRO extends JFrame {
			...
			public Result_ch5MICRO() {
				...
				//call the score for java
				double score = MICROquiz.ch5_MICRO.scores;
				int whole_score = (int) score ;
	 ...
	 class Result_ch6MICRO extends JFrame {
			...
			public Result_ch6MICRO() {
				...
				//call the score for java
				double score = MICROquiz.ch6_MICRO.scores;
				int whole_score = (int) score ;
